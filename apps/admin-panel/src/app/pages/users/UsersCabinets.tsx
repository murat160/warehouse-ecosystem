  ...
  return (
    <div className="space-y-5 pb-8">
      ...
      <div className="flex items-start justify-between gap-4 flex-wrap">
        ...
        <button onClick={() => {
            if (filtered.length === 0) { toast.info('Нет кабинетов для экспорта'); return; }
            exportToCsv(filtered as any[], [
              ...
              { key: 'cabinetModules', label: 'Кастомный набор' },
            ], 'cabinets');
            toast.success(`Скачан CSV: ${filtered.length} кабинетов`);
          }}
