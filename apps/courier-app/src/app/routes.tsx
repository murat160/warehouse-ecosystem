...
export const router = createMemoryRouter(
  [
    ...
    // Aliases / legacy
    { path: '/support',                        Component: Chat },
    { path: '/delivery-settings',              Component: Settings },
    { path: '/analytics',                      Component: Profile },
    { path: '/rewards',                        Component: Profile },
    { path: '/statistics',                     Component: Profile },
    { path: '/news',                           Component: Help },
  ],
  {
    future: {
